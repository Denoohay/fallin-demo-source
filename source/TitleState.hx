...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		backdrop.frames = Paths.getSparrowAtlas('titleBackground');
		backdrop.antialiasing = true;
		backdrop.animation.addByPrefix('still', 'nothinghappens', 24);
		backdrop.animation.play('still');
		backdrop.updateHitbox();
		// backdrop.color = FlxColor.BLACK;
		add(backdrop);
		...
		add(gfDance);
		add(logoBl);
		FlxTween.tween(gfDance, {y: gfDance.y + 50, x: gfDance.x - 30}, 2.5, {ease: FlxEase.quadInOut, type: PINGPONG});
